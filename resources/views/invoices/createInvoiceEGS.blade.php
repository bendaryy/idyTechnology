                                            ...
                                            <div class="accordion-body" id="newOne">
                                                ...
                                                <div class="border border-3 p-4 rounded">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="itemCode[]" onchange="bigOne()" onkeyup="bigOne()" onmouseover="bigOne()"  id="itemCode"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="invoiceDescription[]"  onchange="bigOne()" onkeyup="bigOne()" onmouseover="bigOne()" required class="form-control"
                ...
                $('#newOne').append(
                    `<div id="row${i}">
                             ...
                             <div class="mb-3">
                                <label for="inputProductTitle"
                                    class="form-label">@lang("site.Line Item")</label>
                                <select name="itemCode[]" onchange="bigOne${i}()" onmouseover="bigOne${i}()" onkeyup="bigOne${i}()" id="itemCode${i}"
                                                            class="form-control form-control-sm form-select single-select" required>
                                                            @foreach ($products as $product)
                                                                <option value="{{ $product['itemCode'] }}"
                                                                    style="font-size: 20px">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="invoiceDescription[]" onchange="bigOne${i}()" onmouseover="bigOne${i}()" onkeyup="bigOne${i}()" required class="form-control" id="inputProductDescription${i}" rows="2"></textarea>
                                </div>
                                <div class="row g-3">
                                    <div class="col-md-6">
