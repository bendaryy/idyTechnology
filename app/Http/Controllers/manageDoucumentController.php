...
// this is for receiver address
        ...
        $myFileToJson = fopen("C:\laragon\www\idy\EInvoicing\SourceDocumentJson.json", "w") or die("unable to open file");
...
// this function for signature
    ...
    public function openBat()
    {
        ...
        shell_exec('C:\laragon\www\idy\EInvoicing/SubmitInvoices2.bat');
        $path = "C:\laragon\www\idy\EInvoicing/FullSignedDocument.json";
        $path2 = "C:\laragon\www\idy\EInvoicing/Cades.txt";
        $path3 = "C:\laragon\www\idy\EInvoicing/CanonicalString.txt";
        $path4 = "C:\laragon\www\idy\EInvoicing/SourceDocumentJson.json";
